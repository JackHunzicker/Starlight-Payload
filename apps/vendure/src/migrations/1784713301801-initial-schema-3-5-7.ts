...
export class InitialSchema3571784713301801 implements MigrationInterface {
   ...
   public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_cmpdd22193eda94668e84d33f18" ON "order_line" ("productVariantId") `, undefined);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_c9ca2f58d4517460435cmpa8b4c" ON "channel" ("defaultShippingZoneId") `, undefined);
        ...
        await queryRunner.query(`CREATE TABLE "product_channels_channel" ("productId" integer NOT NULL, "channelId" integer NOT NULL, CONSTRAINT "PK_722acmpdc06403e693b518d2c345" PRIMARY KEY ("productId", "channelId"))`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "order_line" ADD CONSTRAINT "FK_cmpdd22193eda94668e84d33f185" FOREIGN KEY ("productVariantId") REFERENCES "product_variant"("id") ON DELETE CASCADE ON UPDATE NO ACTION`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "channel" ADD CONSTRAINT "FK_c9ca2f58d4517460435cmpa8b4c9" FOREIGN KEY ("defaultShippingZoneId") REFERENCES "zone"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`, undefined);
   ...
   public async down(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query(`ALTER TABLE "channel" DROP CONSTRAINT "FK_c9ca2f58d4517460435cmpa8b4c9"`, undefined);
        ...
        await queryRunner.query(`ALTER TABLE "order_line" DROP CONSTRAINT "FK_cmpdd22193eda94668e84d33f185"`, undefined);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_c9ca2f58d4517460435cmpa8b4c"`, undefined);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_cmpdd22193eda94668e84d33f18"`, undefined);
